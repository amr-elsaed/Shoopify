...
namespace Shoopify.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        {
             optionsBuilder.UseSqlServer("Server=.;Database=Shoopify;Trusted_Connection=True;Encrypt=True;TrustServerCertificate=True;");
        }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ProductIngredient>().HasOne(pi => pi.Product)
                .WithMany(p => p.ProductIngredients).HasForeignKey(pi => pi.ProductId);
            builder.Entity<ProductIngredient>().HasOne(pi=>pi.Ingredient).WithMany(i=>i.ProductIngredients)
